...
from keras.layers import Cropping2D, Flatten, Dense, Lambda, Convolution2D, MaxPooling2D
...
def getImage(source_path):
    """
    Return an image from the path retrieved from the driving log of the
    training mode.
    """
...
## Getting the training (including validation) set
#images = []
#angles = []
